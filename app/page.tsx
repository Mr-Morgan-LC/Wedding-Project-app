...
import { useEffect, useState, useRef } from 'react'; // Đã thêm useState, useRef
import AOS from "aos";
...
// --- COMPONENT HIỆU ỨNG RƠI (Hòa quyện Tuyết & Trái tim) ---
        ...
        return (
          ...
          >
            ...
            {isHeart ? (
              ...
              // Sử dụng file icon-heart.png của bạn
...
export default function WeddingInvitation() {
  ...
  return (
    ...
    <div className="bg-[#1a1a1a] min-h-screen flex justify-center p-0 md:p-4 font-sans text-gray-800 relative">
      ...
      className="relative z-10 text-center px-4 pt-10 mt-6"
    ...
    >
      ...
      {/* Xóa style inline cũ đi và thêm greatVibes.className vào đây

      */}

      <h1

        className={`text-4xl font-bold italic text-gray-900 drop-shadow-md ${greatVibes.className}`}
      ...
      >
        ...
        Nhất Lập & Quỳnh Như
          ...
          <div className="relative z-10 text-center w-full px-12 mb-10 space-y-8">
            ...
            <div data-aos="zoom-in">
               ...
               <p className="text-4xl font-black text-gray-900 mt-1" style={{ fontFamily: '"Dancing Script", cursive' }}>Anh Linh</p>
        ...
        <section className="py-12 text-center bg-white relative z-20">
          ...
          <div className="mb-12 italic font-serif text-[20px] text-gray-800 space-y-1 text-xs" data-aos="fade-up">
          ...
          <div className="text-4xl font-cursive text-gray-800 mb-10" data-aos="zoom-in" style={{ fontFamily: '"Great Vibes", cursive' }}>
        ...
        <section className="py-12 px-4 bg-white text-center">
          ...
          <p className="text-[11px] italic font-serif text-gray-600 mb-4" data-aos="fade-up">(Tức Ngày 29 Tháng 6 Năm Bính Ngọ)</p>
